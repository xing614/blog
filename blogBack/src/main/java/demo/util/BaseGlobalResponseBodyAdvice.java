...
public class BaseGlobalResponseBodyAdvice implements ResponseBodyAdvice<Object> {
	...
	public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
		...
		//ueditor的内容不用封装
		if(returnType.getMethod().getDeclaringClass().toString().equals("class demo.controller.UeditorController")) {
			return body;
		}
...
//        }
		...
		System.out.println(this.getClass().getName()+" "+body.toString());
        return body;
	}
