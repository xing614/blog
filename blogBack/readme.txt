...
文章数据相关表：
文章表 ports：随机id，文章标题，正文，摘要，作者，发布时间，修改时间，是否展示，文章缩略名称，文章缩略展示图片，评论总数
评论和回复树形结构
评论comments：评论唯一id，评论内容，评论所属文章id，评论人昵称，评论时间，评论是否被批准
回复表(用来回复评论)reply:id,评论id，回复内容，回复时间，回复人昵称，目标人昵称，回复类型(是回复评论的还是回复回复的)
分类表terms:分类id,分类名，缩略名
terms_relationship文章和分类对应关系表：文章id,分类id
